...
def draw_shotmap(events, filename, team_left_id, left_color=(0.5, 0.78, 0.97, 1), right_color=(0.88, 0.48, 0.37, 1)):
    ...
    for i, event in events.iterrows():
            ...
            if event.extra['shot']['outcome']['name'] == 'Goal':
                ...
                ax.scatter(x,y, s=markersize, edgecolor='black', linewidth=linewidth, facecolor=shot_color, zorder=6, marker='o')
            else:
                ax.scatter(x,y, s=markersize, edgecolor='black', linewidth=linewidth, facecolor=shot_color, zorder=5, marker='X')
    ...
    legend_elements = [
         plt.scatter([], [], s=markersize*1.2, edgecolor='black', linewidth=linewidth, facecolor=(1, 1, 1, 0.8), zorder=5, marker='*', label="Goal"),
         plt.scatter([], [], s=markersize, edgecolor='black', linewidth=linewidth, facecolor=(1, 1, 1, 0.8), zorder=5, marker='o', label="On Target"),
         plt.scatter([], [], s=markersize, edgecolor='black', linewidth=linewidth, facecolor=(1, 1, 1, 0.8), zorder=5, marker='X', label="Off Target"),
         plt.scatter([], [], s=markersize/3, edgecolor='black', linewidth=linewidth, facecolor=(1, 1, 1, 0.8), zorder=5, marker='o', label="Low xG"),
         plt.scatter([], [], s=markersize*2, edgecolor='black', linewidth=linewidth, facecolor=(1, 1, 1, 0.8), zorder=5, marker='o', label="High xG"),
    ]
