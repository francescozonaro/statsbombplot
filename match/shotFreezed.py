...
def draw_shotFreezed(
    ...
    end_x = change_range(event["extra"]["shot"]["end_location"][0], [0, 120], [0, 105])
    ...
    for player in frame:
        ...
        freezed_player_y = 68 - change_range(player["location"][1], [0, 80], [0, 68])
...
teams = api.teams(game_id=g)
players = api.players(game_id=g)
playerNameToJerseyNumber = players.set_index("player_name")["jersey_number"].to_dict()
